...
import TestimonialSlider from '../../components/blog/common/TestimonialSlider';
import FeatureIcon from '../../components/blog/common/FeatureIcon';
import Funfact from '../../components/blog/common/Funfact';
import TeamMemberGrid from '../../components/blog/common/TeamMemberGrid';
                        ...
                        <div className="row row-25 align-items-center">
                            <div className="col-lg-6 col-12 mb-30">
                                <div className="about-image-two">
                                    <img src={require("../../assets/img/about/about-3.jpg")} alt="" />
                        ...
                        <div className="about-wrapper row">
                            <div className="col-sm-6 col-12 order-1 order-lg-2">
                                <div className="about-image about-image-1">
                                    <img src={require("../../assets/img/about/about-1.jpg")} alt="" />
                                </div>
                            </div>
                            <div className="col-sm-6 col-12 order-2 order-lg-3">
                                <div className="about-image about-image-2">
                                    <img src={require("../../assets/img/about/about-2.jpg")} alt="" />
                                </div>
                            </div>
